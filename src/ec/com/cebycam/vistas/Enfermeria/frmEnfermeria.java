 ...
 * @author User
 */
public final class frmEnfermeria extends javax.swing.JFrame {
     ...
     */
    public frmEnfermeria() throws SQLException, IOException {
        initComponents();
        cargarTabla();
        ordenarTabla();
        frmEnfermeria.txtIdEnfermeros.setText(String.valueOf(codigo));
        frmEnfermeria.txtNombreEnfermero.setText(nombreEnfermero);
        frmEnfermeria.txtCategoria.setText(categoria);
        setIconImage(new ImageIcon(getClass().getResource("/ec/com/cebycam/imagenes/icono.png")).getImage());
        setLocationRelativeTo(null);
        this.setDefaultCloseOperation(frmEnfermeria.DO_NOTHING_ON_CLOSE);
        consultar_medicos();
    ...
    private void initComponents() {
        ...
        MenuNuevoPac = new javax.swing.JMenuItem();
        jMenu2 = new javax.swing.JMenu();
        MenuModPaciente = new javax.swing.JMenuItem();
        MenuModSV = new javax.swing.JMenuItem();
        ...
        tablaSignosVitalesPac.setAutoscrolls(false);
        ...
        jMenu1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ec/com/cebycam/imagenes/insertar_256px-0.png"))); // NOI18N
        jMenu1.setText("Inicio");

        MenuNuevoPac.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ec/com/cebycam/imagenes/paciente-0.png"))); // NOI18N
        MenuNuevoPac.setText("Nuevo Paciente");
        MenuNuevoPac.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MenuNuevoPacActionPerformed(evt);
            }
        });
        jMenu1.add(MenuNuevoPac);

        jMenuBar1.add(jMenu1);

        jMenu2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ec/com/cebycam/imagenes/editar_256px-0.png"))); // NOI18N
        jMenu2.setText("Editar");

        MenuModPaciente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ec/com/cebycam/imagenes/atencion-0.png"))); // NOI18N
        MenuModPaciente.setText("Modificar Paciente");
        MenuModPaciente.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MenuModPacienteActionPerformed(evt);
            }
        });
        jMenu2.add(MenuModPaciente);

        MenuModSV.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ec/com/cebycam/imagenes/listar_256px-0.png"))); // NOI18N
        MenuModSV.setText("Modificar S.V");
        MenuModSV.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MenuModSVActionPerformed(evt);
            }
        });
        jMenu2.add(MenuModSV);

        jMenuBar1.add(jMenu2);

        jMenu3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ec/com/cebycam/imagenes/ayuda-0.png"))); // NOI18N
        jMenu3.setText("Ayuda");

        MenuAcerca.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ec/com/cebycam/imagenes/acerca_de_256px-0.png"))); // NOI18N
        ...
        MenuCambiarClave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ec/com/cebycam/imagenes/clave_256px-0.png"))); // NOI18N
        MenuCambiarClave.setText("Cambiar clave");
...
"  FROM public.\"historia clinica\";");
    ...
    public void tiempo(){
        ...
        frmEnfermeria.txtHoraPac.setText(Format);
        Time.valueOf(Format);
    }
    ...
    public void date(){
        ...
        this.txtFechaPac.setText(Format);
    ...
    private void btnGuardarSignosVitalesPacActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarSignosVitalesPacActionPerformed
        ...
        try {
            ...
            Logger.getLogger(frmEnfermeria.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        if(txtHoraPac.getText().equals("")||txtTemperaturaPac.getText().equals("")||txtFrecuenciaCardiacaPac.getText().equals("")||txtSatO2Pac.getText().equals("")||
            ...
            JOptionPane.showMessageDialog(this, "Debe ingresar toda la información",
                ...
                try{
                    String sql="select insertarSignosVitales(?,?,?,?,?,?,?,?,?,?,?,?);";
                    ...
                    try (PreparedStatement ps = con.conectar().prepareStatement(sql)) {
                        ...
                        ps.setInt(9, Integer.parseInt(txtIdEnfermeros.getText()));
                        ps.setInt(10, Integer.parseInt(txtCodigoHistoria.getText()));
                        ps.setDate(11, java.sql.Date.valueOf(txtFechaPac.getText()));
                        ps.setString(12, cmbMedicos.getSelectedItem().toString());
                        ps.execute();
                        ps.close();
                    } catch (IOException ex) {
                        Logger.getLogger(frmEnfermeria.class.getName()).log(Level.SEVERE, null, ex);
                    ...
                    txtTemperaturaPac.setText("");
                    txtFrecuenciaCardiacaPac.setText("");
                    txtSatO2Pac.setText("");
                    txtPresionArtPac.setText("");
                    txtPacSintomas.setText("");
                    txtAntecedentesPac.setText("");
                    txtPacAlergias.setText("");
                    txtFechaPac.setText("");
                    txtHoraPac.setText("");
                    cmbMedicos.setSelectedItem("Seleccione una opción");
    ...
    private void MenuNuevoPacActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenuNuevoPacActionPerformed
        frmInsertarPaciente nuevoPac = new frmInsertarPaciente();
        nuevoPac.setVisible(true);
    }//GEN-LAST:event_MenuNuevoPacActionPerformed

    private void MenuModPacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenuModPacienteActionPerformed
        frmModificarPaciente pac = null;
        try {
            pac = new frmModificarPaciente();
        } catch (IOException ex) {
            Logger.getLogger(frmEnfermeria.class.getName()).log(Level.SEVERE, null, ex);
        }
        pac.setVisible(true);
    }//GEN-LAST:event_MenuModPacienteActionPerformed
...
"  FROM public.\"historia clinica\";");
    ...
    private void MenuModSVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenuModSVActionPerformed
        frmModificarSV sv = null;
        try {
            sv = new frmModificarSV();
        } catch (SQLException | IOException ex) {
            Logger.getLogger(frmEnfermeria.class.getName()).log(Level.SEVERE, null, ex);
        }
        sv.setVisible(true);
    }//GEN-LAST:event_MenuModSVActionPerformed
...
//    }
    ...
    private javax.swing.JMenuItem MenuModPaciente;
    private javax.swing.JMenuItem MenuModSV;
    private javax.swing.JMenuItem MenuNuevoPac;

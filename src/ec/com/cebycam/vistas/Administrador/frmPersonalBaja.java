...
public final class frmPersonalBaja extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("CEBYCAM-CES :: Historial Personal");
        setResizable(false);
...
"  FROM \"personal_baja\" personal inner join \"administrador\" administrador on \"personal\".administrador=administrador.codigo");
    ...
    private void tablaPersonalBajaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaPersonalBajaMouseClicked
        ...
        if(txtEspecialidades.getText().equals("ENFERMERIA")){
            labelImagen.setIcon(new ImageIcon(getClass().getResource("/ec/com/cebycam/imagenes/enfermera.png")));
        }else{
            labelImagen.setText("");
            labelImagen.setIcon(new ImageIcon(getClass().getResource("/ec/com/cebycam/imagenes/doctor.png")));
        }
